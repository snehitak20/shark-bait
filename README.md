...
<img src=".assets/images/CSS-snapshot.jpg" alt="CSS screenshot with CSS file comments">  
<img src=".assets/images/HTML-screenshot.jpg" alt="HTML screenshots with the different tag changes">
